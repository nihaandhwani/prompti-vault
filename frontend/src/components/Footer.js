      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-6 text-sm">
            ...
            <a 
              href="mailto:partnerships@dhwaniris.com"
              className="text-[#53435B] hover:text-[#811622] transition-colors"
            >
              Contact Us
            </a>
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 text-center text-xs text-[#53435B]">
          © {new Date().getFullYear()} Dhwani RIS. All rights reserved. | Transforming the development sector with innovative solutions
        </div>
      </div>
    </footer>
  );
